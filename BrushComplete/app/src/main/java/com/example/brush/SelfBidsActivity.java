...
public class SelfBidsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self_bids);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        userRef = FirebaseDatabase.getInstance().getReference().child("Users");
        postsRef = FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserID).child("Type").child("B");


        mToolbar = findViewById(R.id.b_toolbar);
    ...
    {
        Intent mainIntent = new Intent (SelfBidsActivity.this,UserProfileActivity.class );
