...
public class AnnouncementPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a_post = findViewById(R.id.a_post);
        ...
        ProfileRef = FirebaseDatabase.getInstance().getReference().child("Users").child(current_user_id).child("Type").child("A");
        UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(current_user_id);

        mToolbar = findViewById(R.id.a_page_toolbar);
    ...
    private void SavingAnnouncementToDatabase(String description, String title)
    {
        ...
        ProfileRef.child(current_user_id + postRandomName).updateChildren(aMap);
    ...
    {
        Intent mainIntent = new Intent (AnnouncementPostActivity.this,NewPostActivity.class );
