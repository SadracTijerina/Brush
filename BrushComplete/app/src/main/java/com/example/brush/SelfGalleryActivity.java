...
public class SelfGalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self_gallery);

        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        userRef = FirebaseDatabase.getInstance().getReference().child("Users");
        postsRef = FirebaseDatabase.getInstance().getReference().child("Users").child(currentUserID).child("Type").child("G");


        mToolbar = findViewById(R.id.gallery_page_toolbar);
    ...
    {
        Intent mainIntent = new Intent (SelfGalleryActivity.this,UserProfileActivity.class );
