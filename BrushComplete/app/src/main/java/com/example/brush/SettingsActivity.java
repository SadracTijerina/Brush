...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_toolbar = findViewById(R.id.user_profile_settings_toolbar);
        ...
        full_name = findViewById(R.id.user_profile_settings_full_name);
        username = findViewById(R.id.user_profile_settings_username);
        bio = findViewById(R.id.user_profile_settings_bio);
        edit_picture = findViewById(R.id.user_profile_settings_default_pic);
        settings_confirm = findViewById(R.id.user_profile_settings_confirm);
        ...
        bio.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                //actionId 4 for actionDone And 6 for actionSend
