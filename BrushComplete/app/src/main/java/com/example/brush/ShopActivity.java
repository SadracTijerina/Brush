...
public class ShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postsRef = FirebaseDatabase.getInstance().getReference().child("Users").child(profile_ID).child("Type").child("B");


        mToolbar = findViewById(R.id.shop_toolbar);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        while (i < num) {
                            ...
                            if (model.getPostType().equals("bid")) {
                                if (model.getUid().equals(profile_ID)) {
                                    choice = 0;
                                    ...
                                    viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        {
                                            Intent bidIntent = new Intent(ShopActivity.this, SelectionActivity.class);
