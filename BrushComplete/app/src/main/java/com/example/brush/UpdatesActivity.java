...
public class UpdatesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postsRef = FirebaseDatabase.getInstance().getReference().child("Users").child(profile_ID).child("Type").child("A");


        mToolbar = findViewById(R.id.pa_toolbar);
    ...
    {
        Intent mainIntent = new Intent (UpdatesActivity.this,MainActivity.class );
